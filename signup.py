...
signup_widnow.iconphoto(True, icon_photo)
...
background_label = Label(signup_widnow, image=background)
background_label.place(x=0, y=0)


signup_frame = Frame(signup_widnow, width=300, height=450, bg="white", pady="10")
...
signup_widnow.geometry('925x500+300+200')

signup_widnow.configure(bg='#fff')

signup_widnow.resizable(False, False)

signup_widnow.mainloop()
